...
function RenderManager:dxDrawText(text, x, y, width, height, color, size, font, ax, ay, clip, brea, postgui, ...)
	return dxDrawText(text, x/self.ScreenWidth*self.sx, y/self.ScreenHeight*self.sy, width/self.ScreenWidth*self.sx, height/self.ScreenHeight*self.sy, color, size/(self.ScreenWidth+self.ScreenHeight)*(self.sx+self.sy), font, ax, ay, clip, brea, postgui, ...)
end
...
function RenderManager:dxDrawImage(x, y, width, height, image, rx, ry, rz, color, postgui)
	return dxDrawImage(x/self.ScreenWidth*self.sx, y/self.ScreenHeight*self.sy, width/self.ScreenWidth*self.sx, height/self.ScreenHeight*self.sy, image, rx, ry, rz, color, postgui)
end
...
--u/self.ScreenHeight*self.sy, v/self.ScreenHeight*self.sy, usize/self.ScreenHeight*self.sy, vsize/self.ScreenHeight*self.sy
	return dxDrawImageSection(x/self.ScreenWidth*self.sx, y/self.ScreenHeight*self.sy, width/self.ScreenWidth*self.sx, height/self.ScreenHeight*self.sy, u, v, usize, vsize, image, rx, ry, rz, color, postgui)
end
...
function RenderManager:dxDrawRectangle(x, y, width, height, color, gui)
	return dxDrawRectangle(x/self.ScreenWidth*self.sx, y/self.ScreenHeight*self.sy, width/self.ScreenWidth*self.sx, height/self.ScreenHeight*self.sy, color, gui)
end
